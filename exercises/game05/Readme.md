**Above the clouds is a game where the player will spond on a cloud and will have to make it to the rainbow (finish line). The player will use the new sponding clouds to jump on and collect coins.
